...
namespace GymPFF.Controllers
{
    public class SalaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SalaId,Nombre,DescripcionActividad")] Sala sala)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SalaId,Nombre,DescripcionActividad")] Sala sala)
        {
            if (id != sala.SalaId)
            {
                return NotFound();
